...
def main():
    parser = argparse.ArgumentParser(prog = 'TecanParser', 
                                     description = 'Processes the kinetic measurements produced by multiwell microplate readers of Tecan® (Infinite 200 Pro series) and converts them into tidy excel tables and simple plots. Current version can handle up to two different measurements.'
                                     )
    ...
    #read the tecan file as pandas df
