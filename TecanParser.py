...
parser.add_argument('-m1', '--measurement1', help = 'Name of your first type of measurements (e.g., OD600, growth, luminescence, etc.)', required = True, default = 'OD')
...
tdplot.separate_lineplots_w_stdev_as_shadows(replicates, ncols, nrows, fig_size, 
                                      ...
                                      ylabel = 'normalized_' + keyword2, same_yscale=True)

plt.savefig(outputname + '_' + 'normalized_' + keyword2 + "_separate" + ".pdf", format = "pdf")
plt.show()
